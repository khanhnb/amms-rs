...
use std::sync::Arc;
use amms::amms::amm::{AMMType, FlashType, SwapType};
...
async fn main() -> eyre::Result<()> {
    ...
    let pool = UniswapV2Pool::new(address!("B4e16d0168e52d35CaCD2c6185b44281Ec28C9Dc"), 300, AMMType::UniswapV2, SwapType::V2, FlashType::Normal)
