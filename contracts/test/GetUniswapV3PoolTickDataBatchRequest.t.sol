...
contract GetUniswapV3PoolTickDataBatchRequestTest is Test {
    ...
    int24[] public ticks = [
        -887220, -82920, -80400, -79740, -79680, -77520, -77100, -75900, -74880
    ];
    ...
    function test_Batch() public {
        console.log("start");
        GetUniswapV3PoolTickDataBatchRequest.TickDataInfo[] memory input =
            new GetUniswapV3PoolTickDataBatchRequest.TickDataInfo[](1);

        input[0] =
            GetUniswapV3PoolTickDataBatchRequest.TickDataInfo(pool, ticks);
