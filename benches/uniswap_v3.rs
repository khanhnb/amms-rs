...
use amms::amms::{amm::{AMMType, AutomatedMarketMaker, FlashType, SwapType}, uniswap_v3::UniswapV3Pool};
...
fn simulate_swap(c: &mut Criterion) {
    ...
    let pool = runtime.block_on(async {
        UniswapV3Pool::new(address!("88e6A0c2dDD26FEEb64F039a2c41296FcB3f5640"), AMMType::UniswapV3, SwapType::V3, FlashType::Normal)
